...
#(cd switch-lame; $MAKEPKG --needed --noconfirm;)
#(cd switch-libvpx; $MAKEPKG --needed --noconfirm;)
(cd switch-libavcodec; $MAKEPKG --needed --noconfirm -f;)
#(cd switch-openssl; $MAKEPKG --needed --noconfirm -f;)
